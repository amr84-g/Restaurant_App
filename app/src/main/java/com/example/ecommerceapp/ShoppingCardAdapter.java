...
public class ShoppingCardAdapter extends RecyclerView.Adapter<ShoppingCardAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.Card_imagepastaShow.setImageResource(Integer.parseInt(products.get(position).getPro_img()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        RoundedImageView Card_imagepastaShow;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            Card_imagepastaShow = itemView.findViewById(R.id.ImagepastaShow);
